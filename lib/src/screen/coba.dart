...
class _MyHomePageState extends State<MyHomePage> {
  ...
  static final String appSecret =
      'YOUR_INSTAGRAM_APP_SECRET'; //ex ec0660294c82039b12741caba60f440c
  static final String redirectUri =
      'YOUR_REDIRECT_URL'; //ex https://github.com/loydkim
  ...
  final authFunctionUrl =
      'YOUR_FIREBASE_FUNCTION_MAKE_CUSTOM_TOEKN_URL'; //ex https://us-central1-signuptest-beb58.cloudfunctions.net/makeCustomToken
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: <Widget>[
        Scaffold(
          appBar: AppBar(title: Text('Sign Up with Instagram.')),
          body: Center(
            child: Column(
                ...
                _userData != null
                    ...
                    : Padding(
                        ...
                        child: GestureDetector(
                            onTap: () {
                              setState(() => _showInstagramSingUpWeb = true);
                            },
                            child: Container(
                                width: 220,
                                height: 220,
                                child:
                                    Image.asset('images/instagramlogo.png'))),
                      ),
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Center(
                    child: RaisedButton(
                      ...
                      color:
                          _userData != null ? Colors.black : Colors.purple[600],
                      onPressed: () => _userData != null
                          ? _logOut()
                          : setState(() => _showInstagramSingUpWeb = true),
                      child: Text(
                        _userData != null ? 'Log Out' : 'Instagram Log In',
                      ...
                      WebView(
                        ...
                        navigationDelegate: (NavigationRequest request) {
                          if (request.url.startsWith(redirectUri)) {
                            ...
                            var code =
                                request.url.substring(startIndex + 5, endIndex);
                            _logIn(code);
